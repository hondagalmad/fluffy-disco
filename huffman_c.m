function huffman_c(app, output_filename)
    ...
    save_compressed(output_fullpath, encoded_data, dict, symbols, frequencies);
end
...
function save_compressed(filename, encoded_data, dict, symbols, frequencies)
